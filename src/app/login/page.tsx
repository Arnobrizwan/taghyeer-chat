      ...
      <div className="flex min-h-dvh flex-col">
        ...
        */}
        <div className="grid flex-1 lg:grid-cols-2">
          ...
          <aside
            aria-hidden="true"
            className="relative hidden overflow-hidden bg-ink px-12 py-16 lg:flex lg:flex-col lg:justify-center"
          >
            <div className="absolute -top-24 -right-24 size-80 rounded-full bg-vermilion/15 blur-3xl" />

            <div className="relative max-w-md">
              <p className="mb-6 inline-flex items-center gap-2 rounded-full border border-paper/15 px-3 py-1 text-[11px] font-medium tracking-wide text-paper/70 uppercase">
                <span className="size-1.5 rounded-full bg-vermilion-bright" />
                Built for bad signal
              </p>

              <p className="font-display text-[40px] leading-[1.1] text-paper text-balance">
                Your message waits for the
                <span className="text-vermilion-bright italic"> tunnel to end</span>, then
                sends itself.
              </p>
        ...
        <div
          className={
            own
              ...
              : 'bubble-in border border-paper/15 bg-paper/10 px-3 py-[7px] text-sm leading-[1.45] text-paper/90'
          }
        >
          {text}
        </div>
        {state === 'queued' && (
          <span className="mt-1 flex items-center gap-1.5 px-1 text-[11px] font-medium text-amber-soft">
            <span className="size-1.5 rounded-full bg-amber-soft/70" />
